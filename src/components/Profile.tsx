      ...
      <div className="relative shrink-0">
        <div className="p-[2px] rounded-full bg-gradient-to-br from-blue-400 to-violet-500">
          <img
            ...
            className="w-9 h-9 rounded-full object-cover bg-slate-900 block"
            onError={(e) => {
              (e.target as HTMLImageElement).src = FALLBACK_AVATAR;
            }}
          />
        </div>
        <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-400 rounded-full border-2 border-[#060812]" />
      </div>
